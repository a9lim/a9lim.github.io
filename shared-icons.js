...
var _ICON = (function () {
    ...
    var icons = {
        ...
        projMiasma:     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="miter"><path d="M12 2l8.66 5v10L12 22l-8.66-5V7z"/><circle cx="12" cy="12" r="1.4" fill="currentColor"/><circle cx="7" cy="9" r="1" fill="currentColor"/><circle cx="17" cy="9" r="1" fill="currentColor"/><circle cx="12" cy="18" r="1" fill="currentColor"/></svg>',
        projPile:       '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="miter"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.4" fill="currentColor"/><line x1="12" y1="4" x2="12" y2="8.8"/><line x1="18.93" y1="16" x2="14.77" y2="13.6"/><line x1="5.07" y1="16" x2="9.23" y2="13.6"/></svg>',
        projPlasma:     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="miter"><path d="M3 5 C 8 5, 8 19, 12 12 C 16 5, 16 19, 21 19"/><path d="M3 19 C 8 19, 8 5, 12 12 C 16 19, 16 5, 21 5"/><circle cx="12" cy="12" r="1.4" fill="currentColor"/></svg>',
        ...
        projOgdoad:     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="miter"><rect x="6" y="6" width="12" height="12"/><rect x="6" y="6" width="12" height="12" transform="rotate(45 12 12)"/></svg>',
        ...
        projGpqueue:    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="square" stroke-linejoin="miter"><line x1="3" y1="5" x2="9" y2="5"/><line x1="3" y1="8" x2="9" y2="8"/><line x1="3" y1="11" x2="9" y2="11"/><rect x="12" y="11" width="9" height="8"/><line x1="15" y1="11" x2="15" y2="8.5"/><line x1="18" y1="11" x2="18" y2="8.5"/></svg>',
