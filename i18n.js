...
(function () {
    ...
    var STRINGS_EN = {
        ...
        "c.bio.p1": "I'm a9lim! I like studying LLMs and how they work, and a smattering of other things too.",
        ...
        "c.bio.p3.s0": "As a kid, my first real forays into recreationally learning things were really just playing with Colorado Boulder's ",
        "c.bio.p3.s1": "PhET",
        "c.bio.p3.s2": " simulations. They're still a huge inspiration, and most of the projects on this site are sims I wish I could have poked at growing up.",
        "c.bio.p4": "I want to be able to work on things that matter. I think that ASI is probably going to be achieved within the next decade, and there are a lot of ways it could turn out badly for all of us. I want to contribute to preventing that however I can.",
        "c.contact.h": "Contact",
    ...
    var STRINGS_JA = {
        ...
        "c.bio.p1": "a9lim です! LLM とその仕組みを研究するのが好きで、ほかにもいろいろなことに手を出している。",
        ...
        "c.bio.p4": "意味のあることに取り組みたい。今後十年以内に ASI はおそらく実現されると思っているし、それが私たち全員にとって悪い結末を迎えうる道筋も多い。そうならないようにすることへ、できる限り貢献したい。",
        "c.contact.h": "連絡先",
        ...
        "c.pred.th2": "期日",
        "c.ama.h": "好きな話題",
        "c.ama.hint.s0": "仕事について話したい、何か一緒にやりたい、あるいはただ雑談したいという人は、",
        "c.ama.hint.s1": "Twitter",
        "c.ama.hint.s2": " の DM、Discord (@a9lim)、または ",
        "c.ama.hint.s3": "メール",
        "c.ama.hint.s4": " からどうぞ。",
        "c.other.h": "私についてのこと",
