...
// wgsl-metrics: {"bytes":62996,"lines":1511,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-30T22:00:38.494Z
export default function _wgsl_module(rt) {
    ...
    function vert_mode_for_row(iy, ghost, n_interior) {
        if ((iy < ghost)) {
            return bindings.bc.mode_s;
        }
        if ((iy >= (ghost + n_interior))) {
            return bindings.bc.mode_n;
        }
        return BC_PERIODIC;
    }
    ...
    function horiz_mode_for_col(ix, ghost, n_interior) {
        if ((ix < ghost)) {
            return bindings.bc.mode_w;
        }
        if ((ix >= (ghost + n_interior))) {
            return bindings.bc.mode_e;
        }
        return BC_PERIODIC;
    }
