...
// wgsl-opts: {"flatStorage":true,"collectErrors":true,"specializeUniforms":{"stage_params":{"a0":0.75,"a1":0.25,"dt_w":0.25}}}
// wgsl-metrics: {"bytes":74765,"lines":1009,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":20,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-27T17:41:05.252Z
            ...
            if (Oy < __clipYBound) {
                ...
                for (let __gx = Ox; __gx < __clipXn; __gx++) {
                    ...
                    const gid_y = Oy;
                    {
                        ...
                        const u0_blend_x = ((0.75 * _b_U0_n[((idx_c) * 4 + 0) + 0]) + (0.25 * _b_U0_other[((idx_c) * 4 + 0) + 0]));
                        const u0_blend_y = ((0.75 * _b_U0_n[((idx_c) * 4 + 0) + 1]) + (0.25 * _b_U0_other[((idx_c) * 4 + 0) + 1]));
                        const u0_blend_z = ((0.75 * _b_U0_n[((idx_c) * 4 + 0) + 2]) + (0.25 * _b_U0_other[((idx_c) * 4 + 0) + 2]));
                        const u0_blend_w = ((0.75 * _b_U0_n[((idx_c) * 4 + 0) + 3]) + (0.25 * _b_U0_other[((idx_c) * 4 + 0) + 3]));
                        const u1_blend_x = ((0.75 * _b_U1_n[((idx_c) * 4 + 0) + 0]) + (0.25 * _b_U1_other[((idx_c) * 4 + 0) + 0]));
                        const u1_blend_y = ((0.75 * _b_U1_n[((idx_c) * 4 + 0) + 1]) + (0.25 * _b_U1_other[((idx_c) * 4 + 0) + 1]));
                        const u1_blend_z = ((0.75 * _b_U1_n[((idx_c) * 4 + 0) + 2]) + (0.25 * _b_U1_other[((idx_c) * 4 + 0) + 2]));
                        const u1_blend_w = ((0.75 * _b_U1_n[((idx_c) * 4 + 0) + 3]) + (0.25 * _b_U1_other[((idx_c) * 4 + 0) + 3]));
                        let u0_raw_x = (u0_blend_x + ((0.25 * dt) * L0_x));
                        let u0_raw_y = (u0_blend_y + ((0.25 * dt) * L0_y));
                        let u0_raw_z = (u0_blend_z + ((0.25 * dt) * L0_z));
                        let u0_raw_w = (u0_blend_w + ((0.25 * dt) * L0_w));
                        let u1_raw_x = (u1_blend_x + ((0.25 * dt) * L1_x));
                        let u1_raw_y = (u1_blend_y + ((0.25 * dt) * L1_y));
                        let u1_raw_z = (u1_blend_z + ((0.25 * dt) * L1_z));
                        let u1_raw_w = (u1_blend_w + ((0.25 * dt) * L1_w));
