...
// wgsl-metrics: {"bytes":21584,"lines":391,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-27T17:41:05.243Z
            ...
            for (let __gx = Ox; __gx < Xn; __gx++) {
                ...
                const gid_y = Oy;
                {
                    ...
                    if (((ix < n_interior) && (iy < (n_interior + 1)))) {
                        ...
                        _b_By_out[dst] = (((_u_stage_params_a0 * _b_By_n[dst]) + (_u_stage_params_a1 * _b_By_other[dst])) + (coef * curl_e));
                    }
                }
            }
        } else if (Gz === 1) {
