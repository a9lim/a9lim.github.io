...
// wgsl-opts: {"flatStorage":true,"collectErrors":true,"inlineHotFns":["bx_at","by_at"],"specializeUniforms":{"U_uniforms":{"view_mode":4,"grid_n":1024,"grid_n_total":1028,"ghost_w":2}},"fixedWorkgroups":[128,128,1]}
// wgsl-metrics: {"bytes":58133,"lines":1010,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":20}
// generated: 2026-05-30T22:00:38.753Z
export default function _wgsl_module(rt) {
    ...
    function __entry_0_main(workgroups, bindings, domain, origin) {
        ...
        const __clipXBound = 1024;
        const __clipYBound = 1024;
        if (Gy === 1 && Gz === 1) {
            if (Oy < __clipYBound) {
