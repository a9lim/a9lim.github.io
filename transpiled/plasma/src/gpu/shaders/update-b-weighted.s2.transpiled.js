...
// wgsl-metrics: {"bytes":21127,"lines":388,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-30T21:32:08.785Z
            ...
            for (let __gx = Ox; __gx < Xn; __gx++) {
                ...
                const gid_y = Oy;
                {
                    ...
                    if (((ix < (n_interior + 1)) && (iy < n_interior))) {
                        ...
                        _b_Bx_out[dst] = (((0.75 * _b_Bx_n[dst]) + (0.25 * _b_Bx_other[dst])) - (coef * ((ez_top - ez_bot))));
                    }
                    if (((ix < n_interior) && (iy < (n_interior + 1)))) {
                        ...
                        _b_By_out[dst] = (((0.75 * _b_By_n[dst]) + (0.25 * _b_By_other[dst])) + (coef * curl_e));
                    }
                }
            }
        } else if (Gz === 1) {
