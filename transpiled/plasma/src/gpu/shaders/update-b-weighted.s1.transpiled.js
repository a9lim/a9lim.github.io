...
// generated: 2026-05-30T22:00:38.706Z
            ...
            for (let __gx = Ox; __gx < Xn; __gx++) {
                ...
                const gid_y = Oy;
                {
                    ...
                    if (((ix < (n_interior + 1)) && (iy < n_interior))) {
                        ...
                        _b_Bx_out[dst] = (((1 * _b_Bx_n[dst]) + (0 * _b_Bx_other[dst])) - (coef * ((ez_top - ez_bot))));
                    }
                    if (((ix < n_interior) && (iy < (n_interior + 1)))) {
                        ...
                        _b_By_out[dst] = (((1 * _b_By_n[dst]) + (0 * _b_By_other[dst])) + (coef * curl_e));
                    }
                }
            }
        } else if (Gz === 1) {
