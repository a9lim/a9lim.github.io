...
// wgsl-opts: {"flatStorage":true,"collectErrors":true,"specializeUniforms":{"U_uniforms":{"grid_n":512,"grid_n_total":516,"ghost_w":2}},"fixedWorkgroups":[65,65,1]}
...
// generated: 2026-05-27T17:41:05.191Z
export default function _wgsl_module(rt) {
    ...
    function __entry_0_main(workgroups, bindings, domain, origin) {
        ...
        const __clipXBound = (512 + 1);
        const __clipYBound = (512 + 1);
        if (Gy === 1 && Gz === 1) {
            if (Oy < __clipYBound) {
