...
// wgsl-metrics: {"bytes":67396,"lines":1106,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-27T17:41:05.188Z
export default function _wgsl_module(rt) {
    ...
    function __entry_0_main(workgroups, bindings, domain, origin) {
        ...
        const __clipXBound = (_u_U_uniforms_grid_n + 1);
        const __clipYBound = (_u_U_uniforms_grid_n + 1);
        if (Gy === 1 && Gz === 1) {
            if (Oy < __clipYBound) {
