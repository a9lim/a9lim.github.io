...
// wgsl-transpile sha256: 5172364bb7eb411e751f43a13920c3db2475ad539d141d39410e88082c06207a
...
// wgsl-metrics: {"bytes":36184,"lines":679,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-27T17:41:05.167Z
    ...
    function ez_res_prev_corner(cx, cy, n_total, dx_inv) {
        ...
        if ((alpha > 0.0)) {
            ...
            _inl_15: {
                ...
                _inl_15__inl_10: {
                    _inl_15__inl_10_result = ((cy * n_total) + cx);
                    break _inl_15__inl_10;
                }
                const _inl_15_by_R = bindings.By_init[_inl_15__inl_10_result];
                const _inl_15__inl_11_ix = (cx - 1);
                let _inl_15__inl_11_result;
                _inl_15__inl_11: {
                    _inl_15__inl_11_result = ((cy * n_total) + _inl_15__inl_11_ix);
                    break _inl_15__inl_11;
                }
                const _inl_15_by_L = bindings.By_init[_inl_15__inl_11_result];
                let _inl_15__inl_12_result;
                _inl_15__inl_12: {
                    _inl_15__inl_12_result = ((cy * ((n_total + 1))) + cx);
                    break _inl_15__inl_12;
                }
                const _inl_15_bx_U = bindings.Bx_init[_inl_15__inl_12_result];
                const _inl_15__inl_13_iy = (cy - 1);
                let _inl_15__inl_13_result;
                _inl_15__inl_13: {
                    _inl_15__inl_13_result = ((_inl_15__inl_13_iy * ((n_total + 1))) + cx);
                    break _inl_15__inl_13;
                }
                const _inl_15_bx_D = bindings.Bx_init[_inl_15__inl_13_result];
                _inl_15_result = (((((_inl_15_by_R - _inl_15_by_L)) - ((_inl_15_bx_U - _inl_15_bx_D)))) * dx_inv);
                break _inl_15;
            }
            const jz_i = _inl_15_result;
            eta_c = anomalous_eta(Math.abs(jz_i), bindings.U_uniforms.eta, alpha, bindings.U_uniforms.eta_anom_jcrit);
        }
        return (eta_c * jz_p);
    }
