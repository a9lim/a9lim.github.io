...
// source: geon/src/gpu/shaders/trails.wgsl
// helpers-sha256: 165cb4ebb9e35e86beab2561fee3a1f79d834c73f5b65aae6134ec1b4a163356
// wgsl-transpile sha256: ba4616207e5a9c33a1bacba52ddaf21f1c2704c63138682f5ace447f392234bd
...
// wgsl-metrics: {"bytes":13488,"lines":280,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-30T22:00:38.879Z
export default function _wgsl_module(rt) {
    ...
    function __entry_0_main(workgroups, bindings, domain, origin) {
        ...
        const _b_trailX = bindings.trailX;
        const _b_trailY = bindings.trailY;
        const _b_trailWriteIdx = bindings.trailWriteIdx;
        const _b_trailCount = bindings.trailCount;
        ...
        if (Gy === 1 && Gz === 1) {
            for (let __gx = Ox; __gx < Xn; __gx++) {
                ...
                __invocation: {
                    ...
                    const writeIdx = _b_trailWriteIdx[idx];
                    const base = (idx * TRAIL_LEN);
                    _b_trailX[(base + writeIdx)] = p_posX;
                    _b_trailY[(base + writeIdx)] = p_posY;
                    _b_trailWriteIdx[idx] = (((writeIdx + 1)) % TRAIL_LEN);
                    _b_trailCount[idx] = ((TRAIL_LEN) < ((_b_trailCount[idx] + 1)) ? (TRAIL_LEN) : ((_b_trailCount[idx] + 1)));
                }
            }
        } else if (Gz === 1) {
            if (Ox === 0 && Oy === 0) {
    ...
    return { entry, bind, bindings: ["particles","trailX","trailY","trailWriteIdx","trailCount"], entryInfo };
}
