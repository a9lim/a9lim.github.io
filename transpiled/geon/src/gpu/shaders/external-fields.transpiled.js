...
// source: geon/src/gpu/shaders/external-fields.wgsl
// helpers-sha256: 165cb4ebb9e35e86beab2561fee3a1f79d834c73f5b65aae6134ec1b4a163356
// wgsl-transpile sha256: 2c43719a1e1e51bcd27a7589792b7d952e6cb232cf9dcb0d35a7aea47ee4af03
...
// wgsl-metrics: {"bytes":37522,"lines":662,"rtVec":0,"rtPoly":0,"rtAtomic":0,"rtNumeric":0,"fround":0,"hypot":0,"iife":0,"workgroupReductionInits":0,"flatWorkgroupArrays":0,"flatWorkgroupSlots":0,"staticBranchPrunes":0}
// generated: 2026-05-30T22:40:33.675Z
export default function _wgsl_module(rt) {
    ...
    function __entry_0_main(workgroups, bindings, domain, origin) {
        ...
        const _u_uniforms_extGravity = _b_uniforms.extGravity;
        const _u_uniforms_extElectric = _b_uniforms.extElectric;
        const _u_uniforms_extBz = _b_uniforms.extBz;
        const _u_uniforms_extGx = _b_uniforms.extGx;
        const _u_uniforms_extGy = _b_uniforms.extGy;
        const _u_uniforms_extEx = _b_uniforms.extEx;
        const _u_uniforms_extEy = _b_uniforms.extEy;
        ...
        if (Gy === 1 && Gz === 1) {
            for (let __gx = Ox; __gx < Xn; __gx++) {
                ...
                __invocation: {
                    ...
                    const g = _u_uniforms_extGravity;
                    const E = _u_uniforms_extElectric;
                    const Bext = _u_uniforms_extBz;
                    if ((((g == 0.0) && (E == 0.0)) && (Bext == 0.0))) {
                        break __invocation;
                    }
                    let extFx = 0.0;
                    let extFy = 0.0;
                    if ((g != 0.0)) {
                        ...
                        extFx = (extFx + (m * _u_uniforms_extGx));
                        extFy = (extFy + (m * _u_uniforms_extGy));
                    }
                    if ((E != 0.0)) {
                        const q = _b_particles[((idx) * 9 + 5)];
                        extFx = (extFx + (q * _u_uniforms_extEx));
                        extFy = (extFy + (q * _u_uniforms_extEy));
                    }
                    ...
                    if ((Bext != 0.0)) {
                        af_bFields_z = Bext;
                        af_bFields_x = (af_bFields_x + Bext);
                    }
                    {
                        const _wbase = ((idx) * 40);
