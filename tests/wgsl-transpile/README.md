...
### 2. Small-fn inlining  *(landed — Tier 2a)*
...
from 2.91× to 26.78× speedup vs polymorphic, sitting within ~1.2× of
...
### 3. Type resolver + inline-scalar emit + SROA  *(landed)*
