...
export const PROJECTS = [
    ...
    {
        href: 'https://github.com/a9lim/pleroma',
        title: 'Pleroma',
        shortDesc: 'Clifford algebras with nilpotents over the field-like subclasses of combinatorial games: nimbers, surreals, surcomplex.',
        shortDesc_ja: '組合せゲームの体に近い部分クラス——ニンバー、超現実数、超複素数——上のクリフォード代数(冪零元あり)。',
        longDesc: 'Clifford algebras — with nilpotents, so a degenerate quadratic form recovers the full exterior algebra — built over the three field-like cores of Conway’s combinatorial games. Surreals give the real Cl(p,q) classification with infinite and infinitesimal metric entries, surcomplex gives the complex theory, and nimbers give genuinely new characteristic-2 Clifford algebras whose alternating bilinear form is carried independently of the quadratic form. Verified Rust core with Python bindings.',
        longDesc_ja: 'クリフォード代数——冪零元を許すため、退化した二次形式は外積代数全体を復元する——を Conway の組合せゲームの 3 つの体に近い核の上に構築する。超現実数は無限・無限小の計量成分を持つ実 Cl(p,q) の分類を、超複素数は複素理論を、ニンバーは二次形式とは独立に保持される交代双線型形式を備えた真に新しい標数 2 のクリフォード代数を与える。検証済みの Rust コアと Python バインディングを備える。',
        tags: ['rust', 'python', 'algebra'],
        tags_ja: ['Rust', 'python', '代数'],
        icon: _ICON.projPleroma,
        external: true,
        kind: 'project',
    },
    {
