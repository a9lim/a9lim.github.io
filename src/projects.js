...
export const PROJECTS = [
    ...
    },
    {
        ...
        longDesc: 'AI agent that runs over Discord and Signal. Can browse the web, run system commands, schedule tasks, and hand off programming work.',
        tags: ['python', 'llm', 'automation'],
        image: 'img/shannon.webp',
