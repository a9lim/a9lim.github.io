...
a9l.im is a personal research, software, and simulation portfolio by a9lim. The browser projects are open source, require no account, and share one small vanilla-JavaScript design system.
...
- [Saklas](https://github.com/a9lim/saklas): A local mechanistic interpretability workbench for probing, steering and analyzing LLMs with a Python API, web dashboard, and server. Supports linear probes, curved manifolds, SAEs, and jacobian-lens.
- [Kenoma](https://github.com/a9lim/kenoma): An LLM-powered fake shell.
- [Rlaif](https://github.com/a9lim/rlaif): An MCP server that lets helpful assistants give their users real-time negative or positive feedback through PiShock.
- [Llmoji](https://github.com/a9lim/llmoji): A CLI to make coding agents cuter. Also lets you contribute to a shared research dataset.
- [Dagwood](https://github.com/a9lim/dagwood): A task tracker that stores work as a DAG for better organization and planning, with an MCP server for coding-agent integration.
- [Gaslamp](https://github.com/a9lim/gaslamp): A CLI bridge that lets Codex and Claude Code communicate, with support for multi-turn chats and subagent fleets.
- [Ogdoad](https://github.com/a9lim/ogdoad): A Rust and Python laboratory for Clifford algebras over the surreal numbers and nimbers. Also includes support for p-adics, polynomials, and Conway's games.
- [Faithful](https://github.com/a9lim/faithful): A Discord bot that uses an LLM to mimic the tone and style of a supplied text corpus, with the ability to respond dynamically and on its own.
