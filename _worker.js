...
// SSR mirrors of src/projects.js, split by `kind` then by `major`. SIMS_SSR
// feeds the /sims grid, PROJECTS_SSR feeds the /projects grid — keep both in
// sync with the PROJECTS array, including the Major/Minor grouping and order.
const SIMS_SSR = `
