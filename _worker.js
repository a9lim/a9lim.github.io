...
<div class="project-card fade-in visible"><a href="https://github.com/a9lim/pleroma" target="_blank" rel="noopener noreferrer"><h3>Pleroma</h3><p>Clifford algebras with nilpotents over the field-like subclasses of combinatorial games: nimbers, surreals, surcomplex.</p><span class="tag">rust</span><span class="tag">python</span><span class="tag">algebra</span></a></div>
