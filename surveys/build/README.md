...
`surveys/data/` and copies the licensed mental-rotation JPEGs into
`surveys/assets/rotation/`. Raw source datasets stay outside the repository.
...
Licensing and provenance are recorded in `surveys/data/manifest.json`. The ESS item
